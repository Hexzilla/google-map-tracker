...
public class LocationService extends Service
    ...
    public void onCreate() {
        ...
        timeCurrentLocation  = "";
        distance = PreferenceManager.getDefaultSharedPreferences(this).getFloat(AppUtils.DISTANCE, 0);
    }
    ...
    protected void createLocationRequest() {
        ...
        locationRequest.setInterval(AppUtils.UPDATE_INTERVAL_IN_MILLISECONDS);

        locationRequest.setFastestInterval(AppUtils.FASTEST_UPDATE_INTERVAL_IN_MILLISECONDS);
    ...
    private void updateUI() {
        ...
        if (null != currentLocation) {
            ...
            PreferenceManager.getDefaultSharedPreferences(this).edit().putFloat(AppUtils.DISTANCE, distance).apply();
    ...
    private void sendLocationBroadcast(String locationData) {
        ...
        locationIntent.setAction(AppUtils.ACTION);
        locationIntent.putExtra(AppUtils.MESSAGE, locationData);
    ...
    private float getUpdatedDistance() {
        if (currentLocation.getAccuracy() > AppUtils.ACCURACY_THRESHOLD) {
